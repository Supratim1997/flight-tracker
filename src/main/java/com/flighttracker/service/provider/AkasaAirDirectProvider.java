...
@Component
public class AkasaAirDirectProvider implements FlightProvider {

    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;

    public AkasaAirDirectProvider() {
    ...
    public String getProviderName() {
        return AppConstants.PROVIDER_AKASA_DIRECT;
    }
    ...
    public List<ScrapedFlight> searchFlights(String dep, String arr, LocalDate flightDate, String flightType) {
        ...
        String searchUrl = "https://www.akasaair.com/fly/search?from=" + dep.toUpperCase() + "&to=" + arr.toUpperCase() + "&depart=" + formattedDate;
        ...
        try {
            ...
            int pos = html.indexOf("window.akasaData =");
            if (pos != -1) {
                    ...
                    try {
                        ...
                        if (flist.isArray()) {
                            for (JsonNode f : flist) {
                                String flightNo = f.path("flightNo").asText("QP-1102");
                                double price = f.path("fare").asDouble(4150.0);
                                ...
                                flights.add(new ScrapedFlight(
                                        "Akasa Air", flightNo, LocalTime.of(11, 0), LocalTime.of(13, 10),
                                        BigDecimal.valueOf(price), isDirect,
                                        isDirect ? AppConstants.DIRECT_STOPS_TEXT : "1 Stop",
                                        searchUrl, AppConstants.PROVIDER_AKASA_DIRECT
                                ));
                            }
                        }
