...
@Component
public class SpiceJetDirectProvider implements FlightProvider {

    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;

    public SpiceJetDirectProvider() {
    ...
    public String getProviderName() {
        return AppConstants.PROVIDER_SPICEJET_DIRECT;
    }
    ...
    public List<ScrapedFlight> searchFlights(String dep, String arr, LocalDate flightDate, String flightType) {
        ...
        String searchUrl = "https://www.spicejet.com/search?from=" + dep.toUpperCase() + "&to=" + arr.toUpperCase() + "&depart=" + formattedDate;
        ...
        try {
            ...
            int pos = html.indexOf("window.spicejetData =");
            if (pos != -1) {
                    ...
                    try {
                        ...
                        if (flist.isArray()) {
                            for (JsonNode f : flist) {
                                ...
                                double price = f.path("fare").asDouble(4250.0);
                                ...
                                flights.add(new ScrapedFlight(
                                        "SpiceJet", flightNo, LocalTime.of(14, 30), LocalTime.of(16, 45),
                                        BigDecimal.valueOf(price), isDirect,
                                        isDirect ? AppConstants.DIRECT_STOPS_TEXT : "1 Stop",
                                        searchUrl, AppConstants.PROVIDER_SPICEJET_DIRECT
                                ));
                            }
                        }
